# License — All Rights Reserved (Custom Permission Grant)

Copyright (c) 2026. The contents of this addon, excluding third-party resources, are copyrighted to their authors with all rights reserved.

This repository and its contents (the “Software”), including but not limited to source code, media, and documentation, are owned by the Author. Except as expressly permitted below, no rights are granted.

## Permissions (Express Grant)
...
- **Redistribute and bundle** the Software **for free** (including in addon compilations, packs, launchers, updaters, mirrors, or UI packages), **provided that**:
  ...
  - required attribution and license text are preserved; and
  - the distribution complies with the **Conditions** below.
- **Create and distribute add-ons, UIs, and configurations that depend on or integrate with the Software**, including distributing those integrations **for free** under the same free-distribution rules above.
...
4. Remove, obscure, or alter copyright, trademark, attribution, or licensing notices.
...
You may incorporate **portions** of this Software into another addon or project **only if** all of the following are true:

- The portion used is **less than 30%** of the total original Software (by reasonable measurement, including code and/or assets).
